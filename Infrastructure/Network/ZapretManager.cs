...
namespace PlatformLauncher.Infrastructure.Network
{
    ...
    /// <summary>
    /// Распаковывает zdy.zip из папки extra/ в runtimes/zdy/.
    /// Поиск winws.exe: 1) recursive через GetFiles(..., SearchOption.AllDirectories),
    /// 2) если не найдено — создаёт папку lists рядом с exe.
    /// </summary>
